...
function setProxy(url) {
    if (typeof url == "undefined") return request = bluebird.promisify(require("request").defaults({ 
        jar: true,
        family: 4,
        agentOptions: {
            family: 4
...
// Add these to your utils.js file
...
function generateUuid() {
  return generateSessionId(); // Same format as session ID
}
...
function generateHsi() {
  return Math.random().toString().substring(2, 21);
}
...
function generateSerializedState(context) {
  // This would typically be a base64 encoded serialized state
...
module.exports.generateSessionString = generateSessionString;
module.exports.generateHsi = generateHsi;
module.exports.generateClientMutationId = generateClientMutationId;
module.exports.generateSerializedState = generateSerializedState;
module.exports = {
    cleanHTML,
