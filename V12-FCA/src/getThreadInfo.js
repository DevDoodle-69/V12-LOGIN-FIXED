...
function formatThreadGraphQLResponse(data) {
	...
	return {
		...
		// ===================== MODIFIED SECTION =====================
		// This section has been changed to extract specific URLs.
		threadTheme: messageThread.thread_theme ? {
			id: messageThread.thread_theme.id,
			name: messageThread.thread_theme.accessibility_label,
			backgroundUrl: messageThread.thread_theme.background_asset?.image?.uri ?? null,
			iconUrl: messageThread.thread_theme.icon_asset?.image?.uri ?? null
		} : null,
