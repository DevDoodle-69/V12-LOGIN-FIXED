...
const VOICES = [
  ...
  { voice_id: "voice_jay_chou", name: "Jay Chou", gender: "male", language: "Chinese" },
  { voice_id: "voice_诸葛孔明", name: "诸葛孔明", gender: "male", language: "Chinese" },
  ...
  { voice_id: "tangseng", name: "唐僧", gender: "male", language: "zh" },
  { voice_id: "rongmomo", name: "容嬷嬷", gender: "female", language: "zh" },
  { voice_id: "guangtouqiang", name: "光头强", gender: "male", language: "zh" },
  { voice_id: "tianmeinvhai", name: "甜美女孩", gender: "female", language: "zh" },
  { voice_id: "sunwukong", name: "孙悟空", gender: "male", language: "zh" },
  { voice_id: "39ef049a-14c1-4774-8ee8-2e5c012c11a8", name: "Alex", gender: "female", language: "English" },
  { voice_id: "labixiaoxin", name: "蜡笔小新", gender: "male", language: "zh" },
  ...
  { voice_id: "voice_马云", name: "马云", gender: "male", language: "Chinese" },
  { voice_id: "voice_熊二", name: "熊二", gender: "cartoon", language: "Chinese" },
  { voice_id: "taiyizhenren", name: "太乙真人", gender: "cartoon", language: "Chinese" },
  { voice_id: "xiaowanzi", name: "樱桃小丸子", gender: "cartoon", language: "Chinese" },
  { voice_id: "voice_抖音-影视解说", name: "抖音-影视解说", gender: "male", language: "Chinese" },
  { voice_id: "haimianbaobao", name: "海绵宝宝", gender: "cartoon", language: "Chinese" },
  { voice_id: "xiaozhupeiqi", name: "小猪佩奇", gender: "cartoon", language: "Chinese" },
  { voice_id: "yaobing", name: "敖丙", gender: "cartoon", language: "Chinese" },
  { voice_id: "voice_李靖", name: "李靖", gender: "cartoon", language: "Chinese" },
  { voice_id: "voice_温柔妹子", name: "温柔妹子", gender: "female", language: "Chinese" },
  { voice_id: "voice_殷夫人", name: "殷夫人", gender: "cartoon", language: "Chinese" },
  { voice_id: "ghostface", name: "Ghostface", gender: "male", language: "en" },
  { voice_id: "bannite", name: "班尼特", gender: "cartoon", language: "Chinese" },
  { voice_id: "voice_后羿", name: "后羿", gender: "male", language: "Chinese" },
  { voice_id: "voice_钟离", name: "钟离", gender: "male", language: "Chinese" },
  { voice_id: "sonic", name: "Sonic", gender: "male", language: "en" },
  { voice_id: "voice_furina_", name: "Furina", gender: "cartoon", language: "English" },
  { voice_id: "zhazhahui", name: "渣渣灰", gender: "male", language: "Chinese" },
  { voice_id: "wulaoshi", name: "吴老师", gender: "male", language: "zh" }
];
